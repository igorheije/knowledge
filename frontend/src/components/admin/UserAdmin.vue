  ...
  <div class="user-admin">
    <b-form>
      ...
      <b-row v-show="mode==='save'">
        ...
        <b-col md="6" sm="12">
          <b-form-group label="Confirmação da Senha:" label-for="user-confirme-password">
            <b-form-input id="user-confirme-password" type="password" v-model="user.confirmPassword" required placeholder="Confirme a Senha do Usuário..."/>
